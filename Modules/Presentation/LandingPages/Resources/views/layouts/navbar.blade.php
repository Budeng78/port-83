    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex justify-between items-center h-16 md:h-20">
            ...
            <div class="hidden md:flex items-center gap-10">
                ...
                <a href="{{ route('platform.dashboard.login') }}"
                    class="inline-flex items-center justify-center px-8 py-3 rounded-2xl bg-white text-[#081a4d] text-[11px] font-black uppercase tracking-[0.2em] hover:bg-blue-50 hover:shadow-[0_0_25px_rgba(255,255,255,0.4)] transition-all active:scale-95 shadow-lg">
                        Login
                </a>
            </div>
