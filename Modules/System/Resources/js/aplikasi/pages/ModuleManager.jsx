...
export default function ModuleManager() {
    ...
    const [processingAlias, setProcessingAlias] =
        useState(null);
    ...
    const fetchModules = async () => {
        ...
        try {
            ...
            setMessage({
                type: 'error',
                text:
                    'Gagal memuat daftar modul dari server.',
            });
    ...
    const handleToggle = async (alias) => {
        ...
        */
        ...
        try {
            ...
            const response =
                await api.post(
                    `/core/system/modules/${alias}/toggle`
                );
            ...
            if (
                ...
                setMessage({
                    ...
                    text:
                        response.data.message ||
                        'Status modul berhasil diperbarui.',
                });
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p
                                ...
                                "
                            >
                                Kelola status aktif dan non-aktif
                                modul aplikasi secara dinamis.
                            </p>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p
                                ...
                                "
                            >
                                Modul yang terdeteksi pada sistem.
                            </p>
